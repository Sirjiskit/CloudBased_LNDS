                ...
                <?php if ($_SESSION['login_type'] == 1) { ?>
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="./?page=new_student" class="nav-link nav-new_student tree-item">
                                    <i class="fas fa-angle-right nav-icon"></i>
                                    <p>Add New</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="./?page=student_list" class="nav-link nav-student_list tree-item">
                                    <i class="fas fa-angle-right nav-icon"></i>
                                    <p>List</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="./?page=user_list" class="nav-link nav-user_list tree-item">
                                    <i class="fas fa-angle-right nav-icon"></i>
                                    <p>List</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link nav-is-tree nav-edit_lecture_note nav-view_lecture_note">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="./?page=new_lecture_note" class="nav-link nav-lecture_note tree-item">
                                    <i class="fas fa-angle-right nav-icon"></i>
                                    <p>Add New</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="./?page=lecture_note_list" class="nav-link nav-lecture_note_list tree-item">
                                    <i class="fas fa-angle-right nav-icon"></i>
                                    <p>List</p>
                                </a>
                            </li>
